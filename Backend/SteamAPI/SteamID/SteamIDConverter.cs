...
namespace SteamIDs_Engine
{
    ...
    public enum AuthIdType
    {
        ...
        AuthId_Steam2,
        /// <summary>
        /// Steam3 rendered format, ex "8307981"
        /// </summary>
        AuthId_Steam3,
        /// <summary>
    ...
    public class SteamIDRegex
    {
        ...
        /// SteamID2 Regex
        /// </summary>
        public const string Steam2Regex = "^STEAM_1:[0-1]:([0-9]{1,10})$";
        /// <summary>
        /// SteamID32 Regex
        /// </summary>
        public const string Steam32Regex = "^([0-9]{1,10})$";
        /// <summary>
        /// SteamID64 Regex
        /// </summary>
    ...
    public static class SteamIDConvert
    {
        ...
        /// <returns>Returns the SteamID2(STEAM_1:1:000000) string.</returns>
        public static string Steam32ToSteam2(int input)
        {
            if (!Regex.IsMatch(input.ToString(), SteamIDRegex.Steam32Regex))
            {
                return string.Empty;
            }
        ...
        /// <returns></returns>
        public static int Steam2ToSteam32(string input)
        {
        ...
        public static long Steam32ToSteam64(int input)
        {
            if (input < 1L || !Regex.IsMatch(input.ToString((IFormatProvider)CultureInfo.InvariantCulture), "^([0-9]{1,10})$"))
            {
                return 0;
            }
        ...
        public static string Steam64ToSteam2(long communityId)
        {
            ...
            communityId -= num;
            string input = string.Format("STEAM_1:{0}:{1}", num, (communityId / 2L));
            if (!Regex.IsMatch(input, "^STEAM_1:[0-1]:([0-9]{1,10})$"))
            {
                return string.Empty;
            }
            return input;
        ...
        {
            if (!Regex.IsMatch(accountId, "^STEAM_1:[0-1]:([0-9]{1,10})$"))
            {
                return 0;
            }
        ...
        public static int Steam64ToSteam32(long communityId)
        {
            if (communityId < 76561197960265729L || !Regex.IsMatch(communityId.ToString((IFormatProvider)CultureInfo.InvariantCulture), "^7656119([0-9]{10})$"))
            {
                return -1;
        ...
        ///<summary>
        ///   Позволяет получить по кастомному стим линку стим ид, путем парса регуляркой xml профиля.
        ///</summary>
        /// <returns>Возвращает 64 битный SteamId в виде <see cref="string"/></returns>
        public static string GetSteamIdBySteamLink(string steamLink)
        {
            //string link = "https://steamcommunity.com/id/rudiks/";
            // <steamID64>76561198116635803</steamID64>
            using (var client = new WebClient())
            {
                var response = client.DownloadString(steamLink + "?xml=1");

                string pattern = "<steamID64>(.*?)</steamID64>";
        ...
        public static string GetSteam64BySteamLink(string steamLink)
        {
            var steamId = steamLink.Replace(@"https://steamcommunity.com/profiles/", "");
        ...
        public static bool IsValidSteamId(string steamId)
        {
            ...
            if (Regex.IsMatch(steamId, SteamIDRegex.Steam64Regex))
            {
                return true;
            }
            ...
            if (Regex.IsMatch(GetSteam64BySteamLink(steamId), SteamIDRegex.Steam2Regex))
            {
                return true;
            }

            if (Regex.IsMatch(GetSteamIdBySteamLink(steamId), SteamIDRegex.Steam64Regex))
            {
                return true;
            }
    ...
    public class SteamID_Engine
    {
        ...
        /// </summary>
        public int Steam32 { private set; get; }
        /// <summary>
        ...
        public SteamID_Engine(string ID)
        {
            ...
            else if (Regex.IsMatch(WorkingID, SteamIDRegex.Steam32Regex))
            {
                ...
                Steam2 = SteamIDConvert.Steam32ToSteam2(int.Parse(WorkingID));
                Steam32 = int.Parse(WorkingID);
                Steam64 = SteamIDConvert.Steam32ToSteam64(int.Parse(WorkingID));
            }
